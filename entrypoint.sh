...
#echo "$@" --insecure-registry=k3d-6zrayfeedkraycom-registry:63630
#exec "$@" --insecure-registry=k3d-6zrayfeedkraycom-registry:63630
echo "Using insecure registry: "${REGISTRY_HOST}":"${REGISTRY_PORT}" "
exec "$@" --insecure-registry="${REGISTRY_HOST}":"${REGISTRY_PORT}"
